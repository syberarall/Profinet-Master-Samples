...
void static AppTask(PVOID)
{
	...
	//**************************************
	//Call PNIO exit function (need to set SEND_MODE_USER(0) in registry) 
...
void main(void)
{
	...
	sprintf(PnioParams.szStationFile, "StationList (SendSeparated).par");		//Use SEND_PLL     with SendMode = 0 (registry)
	//*****************************
