...
{
	PSTATION_INFO pRxStationList[MAX_RTC3_STATIONS] = { 0 };
...
//*****************************************************
	...
	{
		//Check station name
		if (__PnioCheckStationName(pStation, "ertec-devkit"))
		{
			//*****************************************************
			SYSTEM_SEQ_CAPTURE("APP", __LINE__, 0, TRUE);
			//*****************************************************
...
void main(void)
{
	...
	sprintf(PnioParams.szStationFile, "stationlistDAP8.par");
	//*********************************************
